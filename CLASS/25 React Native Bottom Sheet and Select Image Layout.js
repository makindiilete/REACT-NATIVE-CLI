/*
To create a bottom sheet, we will be using a library 'npm i react-native-raw-bottom-sheet'
*/
...
export const AppImagePicker = React.forwardRef((props, ref) => {
  const options = [
    {
    ...
    <View>
      ...
      >
        {options.map(({ name, icon, onPress }) => (
          <TouchableOpacity key={name} style={styles.layout}>
